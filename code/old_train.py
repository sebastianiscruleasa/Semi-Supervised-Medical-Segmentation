...
from dataloaders.dataset import (BaseDataSets, RandomGenerator,
                                 TwoStreamBatchSampler, SynapseResize)
...
def train(args, snapshot_path):
    ...
    optimizer1 = optim.AdamW(model1.parameters(), lr=base_lr,
                            weight_decay=0.0001)
    optimizer2 = optim.AdamW(model2.parameters(), lr=base_lr,
                            weight_decay=0.0001)
    ...
    dice_loss = losses.LogCoshDiceLoss(num_classes)
    # dice_loss = losses.TverskyLoss(num_classes)
    # dice_loss = losses.FocalTverskyLoss(num_classes, gamma=1.33)
...
if __name__ == "__main__":
    ...
    snapshot_path = "../model/oldTrain/{}_{}/{}".format(
